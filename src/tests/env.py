...
from lib import (
    ENV_VAR_NAME_INTERNAL_MONGO_CONNECTION_URL,
    ENV_VAR_NAME_MONGO_DB,
    ENV_VAR_NAME_MONGO_HOST,
    ENV_VAR_NAME_MONGO_TECHNICAL_PASSWORD,
    ENV_VAR_NAME_MONGO_TECHNICAL_USERNAME,
)
...
def sync(mongo_container: MongoDbContainer) -> MongoDbContainer:
    ...
    os.environ[ENV_VAR_NAME_MONGO_HOST] = "%s:%s" % (
        "localhost",
