...
docker-build-development:
	docker build --build-arg POETRY_VERSION=$(POETRY_VERSION) --build-arg DEVELOPMENT_ENV=local -t $(VENDOR_NAME)/$(IMAGE_NAME)-$(IMAGE_VERSION) .

.PHONY: docker-build-production
docker-build-production:
	docker build --build-arg POETRY_VERSION=$(POETRY_VERSION) --build-arg DEVELOPMENT_ENV=production -t $(VENDOR_NAME)/$(IMAGE_NAME)-$(IMAGE_VERSION) .
